...
import { FaArrowLeft, FaUserEdit, FaExclamationCircle } from "react-icons/fa";
      ...
      <div className="page-container">
        <div className="flex flex-col items-center justify-center py-20">
          <div className="relative">
            ...
            <div className="absolute inset-0 h-12 w-12 rounded-full border-4 border-transparent border-t-primary dark:border-t-blue-400 animate-spin" />
          </div>
          <p className="mt-4 text-gray-500 dark:text-gray-400 text-sm">Loading customer...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="page-container space-y-5 md:space-y-6">
        ...
        <div className="relative bg-white dark:bg-gradient-to-br dark:from-gray-800/60 dark:to-gray-900/80 rounded-2xl border border-gray-200/60 dark:border-gray-700/40 shadow-soft dark:shadow-[0_0_50px_-15px_rgba(0,0,0,0.5)] overflow-hidden p-8">
          <div className="text-center">
            ...
            <h3 className="text-gray-900 dark:text-gray-100 font-semibold mb-2">Customer Not Found</h3>
            <p className="text-gray-500 dark:text-gray-400 text-sm mb-6">The customer you're looking for doesn't exist or has been deleted.</p>
            <button
            ...
            >
              <FaArrowLeft className="w-4 h-4" /> Back to Customers
            </button>
          </div>
        </div>
      </div>
    ...
    <div className="page-container space-y-5 md:space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-500 dark:text-gray-400 text-sm mt-1">
          Update details for <span className="font-medium text-gray-700 dark:text-gray-300">{customer?.name}</span>
        </p>
      </div>
      ...
      <div className="relative bg-white dark:bg-gradient-to-br dark:from-gray-800/60 dark:to-gray-900/80 rounded-2xl border border-gray-200/60 dark:border-gray-700/40 shadow-soft dark:shadow-[0_0_50px_-15px_rgba(0,0,0,0.5)] overflow-hidden">
        ...
        <div className="relative flex items-center gap-3 border-b border-gray-100 dark:border-gray-700/50 px-4 sm:px-6 py-4">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400">Update customer information</p>
          </div>
        </div>

        {/* Card Content */}
        <div className="relative">
          <CustomerForm initialValues={customer} onSubmit={handleSubmit} onCancel={handleCancel} isLoading={submitting} error={error} />
        </div>
      </div>
    </div>
  );
